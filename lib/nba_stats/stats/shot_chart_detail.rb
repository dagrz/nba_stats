...
module NbaStats
  ...
  module ShotChartDetail
    ...
    # @param outcome [xxxxxxxxxx]
    # @param location [xxxxxxxxxx]
    # @param month [Integer]
    # @param season_segment [xxxxxxxxxx]
    # @param date_from [Date]
    # @param date_to [Date]
    # @param opponent_team_id [Integer]
    # @param vs_conference [xxxxxxxxxx]
    # @param vs_division [xxxxxxxxxx]
    # @param position [xxxxxxxxxx]
    # @param rookie_year [String]
    # @param game_segment [xxxxxxxxxx]
