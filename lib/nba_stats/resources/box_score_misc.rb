  ...
  module Resources
    ...
    class BoxScoreMisc < ResourceBase
      ...
      VALID_RESULT_SETS = [
          ...
          :sql_players_misc,  # :game_id, :team_id, :team_abbreviation, :team_city, :player_id, :player_name, :start_position, :comment, :min, :pts_off_tov, :pts_2_nd_chance, :pts_fb, :pts_paint, :opp_pts_off_tov, :opp_pts_2_nd_chance, :opp_pts_fb, :opp_pts_paint, :blk, :blka, :pf, :pfd,
          :sql_teams_misc     # :game_id, :team_id, :team_name, :team_abbreviation, :team_city, :min, :pts_off_tov, :pts_2_nd_chance, :pts_fb, :pts_paint, :opp_pts_off_tov, :opp_pts_2_nd_chance, :opp_pts_fb, :opp_pts_paint, :blk, :blka, :pf, :pfd,
      ].freeze
