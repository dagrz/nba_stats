...
module NbaStats
  ...
  module Resources
    ...
    class BoxScoreFourFactors < ResourceBase
      ...
      VALID_RESULT_SETS = [
          ...
          :sql_players_four_factors,  # :game_id, :team_id, :team_abbreviation, :team_city, :player_id, :player_name, :start_position, :comment, :min, :efg_pct, :fta_rate, :tm_tov_pct, :oreb_pct, :opp_efg_pct, :opp_fta_rate, :opp_tov_pct, :opp_oreb_pct,
          :sql_teams_four_factors     # :game_id, :team_id, :team_name, :team_abbreviation, :team_city, :min, :efg_pct, :fta_rate, :tm_tov_pct, :oreb_pct, :opp_efg_pct, :opp_fta_rate, :opp_tov_pct, :opp_oreb_pct,
      ].freeze
