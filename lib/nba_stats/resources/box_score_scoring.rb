...
module NbaStats
  ...
  module Resources
    ...
    class BoxScoreScoring < ResourceBase
      ...
      VALID_RESULT_SETS = [
          ...
          :sql_players_scoring, #:game_id, :team_id, :team_abbreviation, :team_city, :player_id, :player_name, :start_position, :comment, :min, :pct_fga_2_pt, :pct_fga_3_pt, :pct_pts_2_pt, :pct_pts_2_pt_mr, :pct_pts_3_pt, :pct_pts_fb, :pct_pts_ft, :pct_pts_off_tov, :pct_pts_paint, :pct_ast_2_pm, :pct_uast_2_pm, :pct_ast_3_pm, :pct_uast_3_pm, :pct_ast_fgm, :pct_uast_fgm,
          :sql_teams_scoring    #:game_id, :team_id, :team_name, :team_abbreviation, :team_city, :min, :pct_fga_2_pt, :pct_fga_3_pt, :pct_pts_2_pt, :pct_pts_2_pt_mr, :pct_pts_3_pt, :pct_pts_fb, :pct_pts_ft, :pct_pts_off_tov, :pct_pts_paint, :pct_ast_2_pm, :pct_uast_2_pm, :pct_ast_3_pm, :pct_uast_3_pm, :pct_ast_fgm, :pct_uast_fgm,
      ].freeze
