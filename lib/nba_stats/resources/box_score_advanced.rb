...
module NbaStats
  ...
  module Resources
    ...
    class BoxScoreAdvanced < ResourceBase
      ...
      VALID_RESULT_SETS = [
          ...
          :sql_players_advanced,  # :game_id, :team_id, :team_abbreviation, :team_city, :player_id, :player_name, :start_position, :comment, :min, :off_rating, :def_rating, :net_rating, :ast_pct, :ast_tov, :ast_ratio, :oreb_pct, :dreb_pct, :reb_pct, :tm_tov_pct, :efg_pct, :ts_pct, :usg_pct, :pace, :pie,
          :sql_teams_advanced     # :game_id, :team_id, :team_name, :team_abbreviation, :team_city, :min, :off_rating, :def_rating, :net_rating, :ast_pct, :ast_tov, :ast_ratio, :oreb_pct, :dreb_pct, :reb_pct, :tm_tov_pct, :efg_pct, :ts_pct, :usg_pct, :pace, :pie,
      ].freeze
